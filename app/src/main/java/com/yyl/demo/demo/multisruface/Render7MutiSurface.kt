...
import com.yyl.demo.demo.Render5FBOchild
 ...
 * 0,0(顶点1)     1,0(顶点2)
 */
class Render7MutiSurface(val context: Context) : Renderer {
...
//            0f, 1f, 1f, 1f, 0f, 0f, 1f, 0f
    ...
    var onRenderListener: (textureId: Int) -> Unit = {}
...
//---------------------FBO（帧缓冲对象）---------------------
        ...
        onRenderListener.invoke(textureId)
    }
